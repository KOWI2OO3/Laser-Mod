...
public class PrecisionAssemblerRecipeShapelessSerializer implements RecipeSerializer<PrecisionAssemblerRecipeShapeless> {

    @Override
    public PrecisionAssemblerRecipeShapeless fromJson(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) {
        ...
        return new PrecisionAssemblerRecipeShapeless(recipeId, output, speed, inputBase, inputs);
    }

    @Override
    public @Nullable PrecisionAssemblerRecipeShapeless fromNetwork(@Nonnull ResourceLocation recipeId, @Nonnull FriendlyByteBuf buffer) {
    ...
    @Override
    public void toNetwork(@Nonnull FriendlyByteBuf buffer, @Nonnull PrecisionAssemblerRecipeShapeless recipe) {
