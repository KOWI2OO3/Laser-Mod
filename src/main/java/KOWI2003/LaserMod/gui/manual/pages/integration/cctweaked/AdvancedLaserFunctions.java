...
public class AdvancedLaserFunctions extends GuiContext {
	...
	public AdvancedLaserFunctions(String id) {
		super(id);
	...
	public void init() {
		...
		offset = addPageSelector(x, y, offset, ManualHandler.setDirectionFunction, "setDirection", color, hoverColor, true) - offsetDecr;
	}
}