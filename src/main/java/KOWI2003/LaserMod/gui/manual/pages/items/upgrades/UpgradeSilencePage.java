...
public class UpgradeSilencePage extends GuiContext {
	...
	public void init() {
		...
		addComponent(new TextBoxComponent("info", 0, -30, 200, 0, new float[] {0.4f, 0.4f, 0.4f}, "manual.upgrades.silence.info.base", null));
		addComponent(new TextBoxComponent("info", 0, -10, 200, 0, new float[] {.4f, .4f, .4f}, "manual.upgrades.silence.info.context.laser", null));
