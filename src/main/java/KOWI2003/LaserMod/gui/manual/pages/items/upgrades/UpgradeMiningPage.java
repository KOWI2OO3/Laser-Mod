...
public class UpgradeMiningPage extends GuiContext {
	...
	public void init() {
		...
		addComponent(new TextBoxComponent("info", 0, -30, 200, 0, new float[] {0.4f, 0.4f, 0.4f}, "manual.upgrades.mining.info.base", null));

		addComponent(new TextBoxComponent("info", 0, -5, 200, 0, new float[] {0.4f, 0.4f, 0.4f}, "manual.upgrades.mining.info.context.tools", null));
